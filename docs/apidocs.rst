...
The :class:`CumulocityApi <c8y_model.CumulocityApi>` class is your entrypoint into higher level functions,
...
The ``CumulocityDeviceRegistry`` class provides an additional entry point
